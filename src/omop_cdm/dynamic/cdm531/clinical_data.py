...
class BaseDeathCdm531:
    ...
    death_type_concept_id: Mapped[int] = mapped_column(ForeignKey(FK_CONCEPT_ID), sort_order=400)
...
class BaseDeviceExposureCdm531:
    ...
    visit_detail_id: Mapped[Optional[int]] = mapped_column(ForeignKey(FK_VISIT_DETAIL_ID), sort_order=1300)
    device_source_value: Mapped[Optional[str]] = mapped_column(String(50), sort_order=1400)
    device_source_concept_id: Mapped[Optional[int]] = mapped_column(ForeignKey(FK_CONCEPT_ID), sort_order=1500)
...
class BasePersonCdm531:
    ...
    person_id: Mapped[int] = mapped_column(Integer, primary_key=True, sort_order=100)
...
class BaseProcedureOccurrenceCdm531:
    ...
    modifier_concept_id: Mapped[Optional[int]] = mapped_column(ForeignKey(FK_CONCEPT_ID), sort_order=700)
    ...
    procedure_source_concept_id: Mapped[Optional[int]] = mapped_column(ForeignKey(FK_CONCEPT_ID), sort_order=1300)
...
class BaseVisitDetailCdm531:
    ...
    admitting_source_value: Mapped[Optional[str]] = mapped_column(String(50), sort_order=1300)
    admitting_source_concept_id: Mapped[Optional[int]] = mapped_column(ForeignKey(FK_CONCEPT_ID), sort_order=1400)
    discharge_to_source_value: Mapped[Optional[str]] = mapped_column(String(50), sort_order=1500)
    discharge_to_concept_id: Mapped[Optional[int]] = mapped_column(ForeignKey(FK_CONCEPT_ID), sort_order=1600)
    ...
    @declared_attr
    def admitting_source_concept(cls) -> Mapped["Concept"]:
        return relationship("Concept", foreign_keys="VisitDetail.admitting_source_concept_id")
...
class BaseVisitOccurrenceCdm531:
    ...
    admitting_source_concept_id: Mapped[Optional[int]] = mapped_column(ForeignKey(FK_CONCEPT_ID), sort_order=1300)
    admitting_source_value: Mapped[Optional[str]] = mapped_column(String(50), sort_order=1400)
    discharge_to_concept_id: Mapped[Optional[int]] = mapped_column(ForeignKey(FK_CONCEPT_ID), sort_order=1500)
    ...
    @declared_attr
    def admitting_source_concept(cls) -> Mapped["Concept"]:
        return relationship("Concept", foreign_keys="VisitOccurrence.admitting_source_concept_id")
...
class BaseStemTableCdm531:
    ...
    start_date: Mapped[datetime.date] = mapped_column(Date, sort_order=500)
    ...
    modifier_source_value: Mapped[Optional[str]] = mapped_column(String(50), sort_order=4600)
