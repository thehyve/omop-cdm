...
from omop_cdm.constants import CDM_SCHEMA, FK_CONCEPT_ID, FK_LOCATION_ID, FK_CARE_SITE_ID
...
class BaseCareSiteCdm531:
    ...
    care_site_id: Mapped[int] = mapped_column(Integer, primary_key=True, sort_order=100)
...
class BaseLocationCdm531:
    ...
    location_id: Mapped[int] = mapped_column(Integer, primary_key=True, sort_order=100)
...
class BaseProviderCdm531:
    ...
    provider_id: Mapped[int] = mapped_column(Integer, primary_key=True, sort_order=100)
