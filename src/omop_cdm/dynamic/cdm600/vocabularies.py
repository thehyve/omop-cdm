...
from sqlalchemy import Date, ForeignKey, Integer, Numeric, String, DateTime, CheckConstraint
...
class BaseConceptAncestorCdm600:
...
class BaseConceptRelationshipCdm600:
...
class BaseConceptSynonymCdm600:
...
class BaseSourceToConceptMapCdm600:
...
class BaseSourceToConceptMapVersionCdm600:
