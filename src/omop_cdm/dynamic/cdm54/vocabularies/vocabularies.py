"""OMOP CDM v5.4 vocabulary tables."""
...
class BaseVocabularyCdm54:
    ...
    vocabulary_reference: Mapped[Optional[str]] = mapped_column(String(255), sort_order=300)
...
class BaseSourceToConceptMapCdm54:
    ...
    def source_concept(cls) -> Mapped["Concept"]:
        return relationship("Concept", foreign_keys="SourceToConceptMap.source_concept_id")
