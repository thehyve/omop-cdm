...
class BaseConditionEraCdm54:
    ...
    condition_era_start_date: Mapped[datetime.date] = mapped_column(Date, sort_order=400)
    condition_era_end_date: Mapped[datetime.date] = mapped_column(Date, sort_order=500)
...
class BaseDoseEraCdm54:
    ...
    dose_era_start_date: Mapped[datetime.date] = mapped_column(Date, sort_order=600)
    dose_era_end_date: Mapped[datetime.date] = mapped_column(Date, sort_order=700)
...
class BaseDrugEraCdm54:
    ...
    person_id: Mapped[int] = mapped_column(ForeignKey(FK_PERSON_ID, ondelete="CASCADE"), index=True, sort_order=200)
    drug_concept_id: Mapped[int] = mapped_column(ForeignKey(FK_CONCEPT_ID), index=True, sort_order=300)
    drug_era_start_date: Mapped[datetime.date] = mapped_column(Date, sort_order=400)
    drug_era_end_date: Mapped[datetime.date] = mapped_column(Date, sort_order=500)
